...
choice1 = input(
    "You're are at a cross road. Where do you want to go? Type 'left' or 'right' ").lower()
...
if choice1 == "right":
    ...
    if choice2 == "swim":
        print("You get attacked by an angry trout. Game Over.").lower()
    else:
        choice3 = input(
        ...
        if choice3 == "red":
            print("It's a room full of fire. Game Over.").lower()
        elif choice3 == "blue":
            print("You enter a room of beasts. Game Over.").lower()
        elif choice3 == "yellow":
            print("You found the treasure! You Win!").lower()
        else:
